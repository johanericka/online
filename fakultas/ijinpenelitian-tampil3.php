				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						<form role="FORM" method="POST" >
							...
							Telah disetujui Dosen Pembimbing pada tanggal <?php echo tgl_indo($tglvalidasidosen); ?><br/>
							Telah disetujui Ketua Program Studi pada tanggal <?php echo tgl_indo($tglvalidasijurusan); ?><br/>
							<br/>
							Maka kami mohon dibuatkan surat ijin penelitian / pengambilan data di <br>
							Instansi
							...
							Tanggal pelaksanaan
							<input type="text" class="form-control" name="tglpelaksanaan" value="<?php echo tgl_indo($tglpelaksanaan); ?>" readonly></input>							
							<br/>
							<?php
								$respon = $_GET['respon'];
								if ($respon == "kosong"){
							...
							<button name ="aksi" value="cetak" type="submit" formaction="../mahasiswa/ijinpenelitian-cetak.php?nodata=<?php echo $nodata; ?>" class="btn btn-success"> <i class="fa fa-print"></i> Cetak</button>
						</form>
					</div>
				</div>
