				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						<form role="FORM" method="POST" >
							<label>Saya yang bertanda tangan di bawah ini </label><br/>
							<br/>
							<label>Nama </label><br/>
							...
							<br/>
							<label>Mengajukan Permohonan</label><br/>
							...
							<button name ="aksi" value="setujui" type="submit" formaction="suket-setujui.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
							<button name ="aksi" value="tolak" type="submit" formaction="suket-tolak.php" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
						</form>
					</div>
				</div>
