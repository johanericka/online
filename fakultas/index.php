						...
						<div class="card-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<!-- Ijin Lab as WD-->
									<?php
									$query = mysqli_query($dbsurat, "select * from ijinlab where validatorfakultas='$iduser' AND validasifakultas = 0 AND validasijurusan = 1");
									...
									?>
										<tr>
											...
											<td>
												...
												?>
													<a class="btn btn-info btn-sm" href="lab-tampil4.php?nodata=<?php echo $nodata; ?>">
														<i class="fas fa-search">
														</i>
														Lihat
													</a>
									...
									<!-- PKL wd-->
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM pkl WHERE validatorfakultas='$iduser' AND validasifakultas = 0 and validasijurusan=1");
									$jmldata = mysqli_num_rows($query);
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['id'];
										$nim = $data['nim'];
									...
									<!-- cetak KHS-->
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM cetakkhs WHERE validatorfakultas='$iduser' AND validasifakultas = 0 AND validasijurusan = 1");
									$jmldata = mysqli_num_rows($query);
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['id'];
										$nim = $data['nim'];
									...
									<!-- ijin penelitian -->
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM ijinpenelitian WHERE validatorfakultas='$iduser' AND validasifakultas=0 AND validasijurusan=1");
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['id'];
										$nim = $data['nim'];
										$nama = $data['nama'];
									...
									while ($data = mysqli_fetch_array($query)) {
										...
										//$query2 = mysqli_query($dbsurat,"SELECT * FROM pejabat WHERE kdjurusan = '$kdjurusan'");
									...
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM peminjamanalat WHERE validatorfakultas='$iduser' AND validasifakultas= 0 AND validasijurusan=1");
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['id'];
										$jurusan = $data['jurusan'];
										$nim = $data['nim'];
									...
									<!-- Surat Keterangan -->
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM suket WHERE validatorfakultas='$iduser' AND validasifakultas= 0 AND validasijurusan=1");
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['id'];
										$nim = $data['nim'];
										$nama = $data['nama'];
									...
									<!-- Observasi as wd-->
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM observasi WHERE validatorfakultas='$iduser' AND validasifakultas = 0 AND validasijurusan = 1");
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['id'];
										$nim = $data['nim'];
										$jurusan = $data['jurusan'];
									...
									<!-- pengambilandata -->
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM pengambilandata WHERE validatorfakultas='$iduser' AND validasifakultas = 0 AND validasijurusan = 1");
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['id'];
										$nim = $data['nim'];
										$nama = $data['nama'];
									...
									<!-- SKPI as WD -->
									<?php
									$query = mysqli_query($dbsurat, "SELECT * FROM skpi_prestasipenghargaan WHERE verifikator3='$iduser' AND verifikasi3=0 AND verifikasi2=1 GROUP BY nim");
									while ($data = mysqli_fetch_array($query)) {
										$nodata = $data['no'];
										$nim = $data['nim'];
										$jurmhs = $data['jurusan'];
			...
			<?php if ($iduser == '62007') { ?>
						...
						<div class="card-body p-0">
							...
							<div class="card-body">
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php
										$query = mysqli_query($dbsurat, "select * from wfh where verifikasijurusan=1 and verifikatorfakultas='$iduser'  and verifikasifakultas=0");
										$jmldata = mysqli_num_rows($query);
										while ($data = mysqli_fetch_array($query)) {
											$nodata = $data[0];
											$jurusanstaf = $data[2];
				...
				<section class="content">
					...
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Verifikasi Surat Tugas <i>Work From Home</i> Ketua Program Studi / Kepala Bagian / Dekan</h3>
						</div>
						<!-- /.card-header -->
						<?php $no = 1; ?>
						<div class="card-body p-0">
							...
							<div class="card-body">
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php
										$query = mysqli_query($dbsurat, "select * from wfh where verifikatorjurusan='$iduser' and verifikatorfakultas='$iduser' and verifikasijurusan=0 and verifikasifakultas=0");
										$jmldata = mysqli_num_rows($query);
										while ($data = mysqli_fetch_array($query)) {
											$nodata = $data[0];
											$jurusanstaf = $data[2];
