...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			$qmhs = mysqli_query($dbsurat, "SELECT * FROM skpi WHERE nim='$nim' GROUP BY nim");
							...
							<div class="card-body p-0">
								<table class="table table-striped">
									...
									<tbody>
										...
										$qprestasi = mysqli_query($dbsurat, "SELECT * FROM skpi_prestasipenghargaan WHERE nim='$nim' AND aktivitas IS NOT NULL AND verifikator3='$iduser' AND verifikasi3=0 AND verifikasi2=1");
											...
											<tr>
												<form role="form" method="POST">
													...
													<td>
														...
														<button name="aksi" value="tolak" type="submit" onclick="return confirm('Menolak Sertifikat <?= $data['indonesia']; ?> ?')" formaction="skpi-sertifikat-tolak.php" class="btn btn-sm btn-danger"> <i class="fa fa-times"></i> </button>
													</td>
												</form>
											</tr>
										<?php
						...
						<form role="form" method="POST">
							<div class="card">
								...
								<div class="card-body">
									...
									<?php
									$qcpl = mysqli_query($dbsurat, "SELECT * FROM skpi_cpl WHERE jurusan='" . $jurusanmhs . "' AND cpl='Kemampuan Kerja' ORDER BY indonesia");
										...
										<div class="row">
											<div class="form-group">
												<div class="form-check">
													<?php
													//cari data dari skpi yang di acc dosen
													$qaccdosen = mysqli_query($dbsurat, "SELECT * FROM skpi WHERE nim='$nim' AND cpl='Kemampuan Kerja' and indonesia='$kemampuankerja'");
													$naccdosen = mysqli_num_rows($qaccdosen);
													if ($naccdosen > 0) {
													?>
									...
									<?php
									$qcpl2 = mysqli_query($dbsurat, "SELECT * FROM skpi_cpl WHERE jurusan='" . $jurusanmhs . "' AND cpl='Penguasaan Pengetahuan' ORDER BY indonesia");
										...
										<div class="row">
											<div class="form-group">
												<div class="form-check">
													<?php
													//cari data dari skpi yang di acc dosen
													$qaccdosen = mysqli_query($dbsurat, "SELECT * FROM skpi WHERE nim='$nim' AND cpl='Penguasaan Pengetahuan' and indonesia='$penguasaanpengetahuan'");
													$naccdosen = mysqli_num_rows($qaccdosen);
													if ($naccdosen > 0) {
													?>
									...
									<b>Sikap Khusus</b>
									<?php
									$qcpl3 = mysqli_query($dbsurat, "SELECT * FROM skpi_cpl WHERE jurusan='" . $jurusanmhs . "' AND cpl='Sikap Khusus' ORDER BY indonesia");
										...
										<div class="row">
											<div class="form-group">
												<div class="form-check">
													<?php
													//cari data dari skpi yang di acc dosen
													$qaccdosen = mysqli_query($dbsurat, "SELECT * FROM skpi WHERE nim='$nim' AND cpl='Sikap Khusus' and indonesia='$SikapKhusus'");
													$naccdosen = mysqli_num_rows($qaccdosen);
													if ($naccdosen > 0) {
													?>
							...
							<hr />
							<p style="color:red">Alasan Penolakan (*)</p>
							...
							<button name="aksi" value="setujui" type="submit" formaction="skpi-setujui2.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
							<button name="aksi" value="tolak" type="submit" formaction="skpi-tolak2.php" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
						</form>
					</div>
				</div>
			</section>
