				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						<form role="FORM" method="POST" >
							...
							<button name ="aksi" value="setujui" type="submit" formaction="peminjamanalat-setujui2.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
							<button name ="aksi" value="tolak" type="submit" formaction="peminjamanalat-tolak2.php" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
						</form>
					</div>
				</div>
