				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						<form method="POST">
							...
							<br/>
							<br/>
							<button name ="aksi" value="cetak" type="submit" formaction="../mahasiswa/cetakkhs-cetak.php?nodata=<?php echo $nodata; ?>" class="btn btn-success"> <i class="fa fa-print"></i> Cetak</button>
						</form>
					</div>
				</div>
