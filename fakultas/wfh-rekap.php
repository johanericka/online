		...
		<div class="content-wrapper">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
								<?php
									$query = mysqli_query($dbsurat,"select * from wfh where verifikatorfakultas='$iduser' and verifikasifakultas > 0 order by tglsurat desc");
									...
									while($data = mysqli_fetch_array($query)) {
										...
										$verifikasijurusan = $data['verifikasifakultas'];
										if($verifikasijurusan == 0){
											$status = "Belum di verifikasi jurusan";
										}else{
