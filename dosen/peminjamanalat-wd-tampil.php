...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            $sql = mysqli_query($dbsurat, "SELECT * FROM peminjamanalat WHERE no='$nodata'");
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    Telah disetujui oleh Ketua Program Studi <?= $prodi; ?> <?= namadosen($dbsurat, $validator2) ?> pada <?= tgljam_indo($tglvalidasi2); ?><br />
                                    <hr>
                                    <form role="form" method="POST">
                                        <input type="hidden" name="nodata" value="<?php echo $nodata; ?>"></input>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <button name="aksi" value="setujui" type="submit" formaction="peminjamanalat-wd-setujui.php" class="btn btn-success btn-block" onclick="return confirm('Apakah anda yakin akan MENYETUJUI pengajuan ini ?')"> <i class="fa fa-check"></i> Setujui</button>
                                            </div>
                                            <div class="col-lg-6">
