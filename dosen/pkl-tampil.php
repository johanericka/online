...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			$datamhs = mysqli_query($dbsurat, "select * from pkl where id='$nodata'");
			...
			<div class="content">
				<div class="container-fluid">
					...
					<form role="form" method="POST" action="lab-simpan.php">
						...
						<button name="aksi" value="setujui" type="submit" formaction="pkl-setujui.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
						<button name="aksi" value="tolak" type="submit" formaction="pkl-tolak.php?" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
					</form>
					<br />
				</div>
			</div>
