                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <form role="form" method="POST" action="skpi-setujui.php">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <button name="aksi" value="setujui" type="submit" formaction="skpi-wd-setujui.php" class="btn btn-success btn-block" onclick="return confirm('Apakah anda menyetujui pengajuan ini ?')"> <i class="fa fa-check"></i> Setujui</button>
                                </div>
                                <div class="col-lg-6">
