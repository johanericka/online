...
$sql1 = mysqli_query($dbsurat, "SELECT * FROM peminjamanalat WHERE no='$nodata'");
...
$pesan = "Yth. " . $namamhs . "<br/>
        ...
        <br/>
        <a href='https://saintek.uin-malang.ac.id/online/mahasiswa/peminjamanalat-cetak.php?nodata=$nodata' style=' background-color: #0045CE;border: none;color: white;padding: 8px 16px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;'>Cetak Surat Ijin Penelitian</a><br/>
        <br/>
