						...
						<form role="form" method="post" action="wfh-simpan.php">
							...
							?>
								<div class="alert alert-danger alert-dismissible fade show">
									...
									<strong>ERROR!</strong> Uraian kegiatan harus di isi!
								</div>
							<?php
							};
							?>
							<textarea class="form-control" rows="3" id="kegiatan1" name="kegiatan1" placeholder="uraian kegiatan WFH 1" /></textarea>
							...
							<textarea class="form-control" rows="3" id="kegiatan2" name="kegiatan2" placeholder="uraian kegiatan WFH 2" /></textarea>
							<br />
