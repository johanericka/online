					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview menu-close">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="http://saintek.uin-malang.ac.id/wfh/doc/SE3001-2020.pdf" target="_blank" class="nav-link">
										<i class="far fa-file-pdf"></i>
										<p>SE Sterilisasi Kampus</p>
									</a>
								</li>
								<li class="nav-item">
					...
					<div class="card-body p-0">
						...
						<div class="card-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									$query = mysqli_query($dbsurat, "select * from wfh where verifikatorjurusan='$iduser' AND verifikatorfakultas='$iduser' AND verifikasijurusan=0");
