				...
				<div class="container-fluid">
					Saya yang bertanda tangan di bawah ini <br/>
						...
						<form role="form" method="POST">
							...
							<button name ="aksi" value="setujui" type="submit" formaction="suket-setujui2.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
							<button name ="aksi" value="tolak" type="submit" formaction="suket-tolak2.php?" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
						</form>
 			  </div>
			</div>
		</div>
