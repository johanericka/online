	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<?php
				...
				$qmhs = mysqli_query($dbsurat,"SELECT * FROM skpi_prestasipenghargaan WHERE nim='$nim' AND verifikasi1=0");
				...
				<div class="content">
					<div class="container-fluid">
						...
						<form role="form" method="POST" action="skpi-setujui.php">
							...
							<input type="hidden" class="form-control" name="dosen" value="<?= $dosen;?>"/>
