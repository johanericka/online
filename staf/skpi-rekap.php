									...
									?>
										<tr>
											...
											<td width="30%">
												...
												if ($verifikasi1 == 0) {
												?>
													Menunggu <i class="fa fa-spinner" aria-hidden="true"></i> <br />
												<?php
												} elseif ($verifikasi1 == 1) {
												?>
													Menyetujui <i class="fa fa-check" aria-hidden="true"></i> <br />
												<?php
												} else {
												?>
													Menolak <i class="fa fa-ban" aria-hidden="true"></i> <br />
												<?php
												};
												?>
												KAPRODI
