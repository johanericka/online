		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h3>Pengajuan Rekomendasi Keringanan UKT</h3>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
			...
			<!-- dapatkan no surat -->
			<?php
				$query = mysqli_query($dbsurat,"SELECT * FROM suket WHERE nim='$nim' AND validasidosen IS NULL");
			...
			<section class="content">
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						<b>Lampiran - 
						<a href="https://siakad.uin-malang.ac.id" target="_blank">Kartu Hasil Studi</a>
						</b>
						<br/>
						<form action="ajaxupload.php" enctype="multipart/form-data" class="form-horizontal" method="post">										
							...
							<button class="btn btn-block btn-primary btn-upload" name="upload" value="khs"><i class="fa fa-arrow-up"></i> Upload Kartu Hasil Studi</button>
						</form>
						<br/>
						<?php 
							if($cekhasil > 0){
						?>
							<a href="index.php" class="btn btn-success"><i class="fa fa-check "></i> Ajukan </a>
						<?php
							}else{
						?>
							<a href="index.php" class="btn btn-success disabled"><i class="fa fa-check"></i> Ajukan </a>
						<?php
							}
						?>
						<br/>
