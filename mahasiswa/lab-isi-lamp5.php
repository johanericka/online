			...
			<section class="content">
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						...
						<br/>
						Scan Surat Pernyataan Kesanggupan Mengikuti Protokol Kesehatan <a href="http://saintek.uin-malang.ac.id/online/doc/Lampiran5.docx"><b>Download Form Lampiran 5</b></a>
						<br/>
						<br/>
						...
						?>
						<br/>
						<a href="lab-isi-lamp4.php" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali </a>
						<?php 
							if($cekhasil > 0){
						?>
