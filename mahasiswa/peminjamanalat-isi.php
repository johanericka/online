				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						...
						<form role="form" method="post" action="peminjamanalat-simpan.php">
							...
							<textarea class="form-control" rows="3" name="judulskripsi" placeholder="judul skripsi / penelitian" value=""/></textarea>
							<br/>
							<label>Dosen Pembimbing </label><br/>
							<div class="form-group">
								<div class="search-box">
									<input type="text" autocomplete="off" placeholder="cari dosen" name="namadosen"/>
							...
							<input type="text" class="form-control" name="pimpinaninstansi" placeholder="pimpinan instansi" /></input>
							<br/>
							<label>Nama Instansi</label>
							<input type="text" class="form-control" name="instansi" placeholder="nama instansi" /></input>
							<br/>
							<label>Alamat</label>
							<textarea class="form-control" rows="3" name="alamat" placeholder="alamat instansi" /></textarea>
							<br/>
							<label>Nama & spesifikasi alat</label>
							<textarea class="form-control" rows="3" name="namaalat" placeholder="nama & spesifikasi alat" /></textarea>
							<br/>
							<label>Jumlah alat</label>
							<input type="number" class="form-control" name="jumlahalat" placeholder="1" /></input>
							<br/>
							<label>Waktu peminjaman</label>
							<div class="form-group">
								Mulai peminjaman
								<input type="date" id="tglpeminjamanmulai" name="tanggalmulai"><br/>
								Akhir peminjaman
								<input type="date" id="tglpeminjamanakhir" name="tanggalakhir"><br/>
							</div>
