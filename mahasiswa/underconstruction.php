		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h3>Sedang dalam perbaikan ...</i></h3>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
			...
			<section class="content">
				<div class="content">
					<div class="container-fluid">
						...
						<h2 style="text-align:center">Untuk peningkatan pelayanan, fasilitas ini sedang dalam pengembangan lebih lanjut. </h2>
						<h2 style="text-align:center">Silahkan coba kembali fasilitas ini beberapa saat lagi</h2>
						<br/>
