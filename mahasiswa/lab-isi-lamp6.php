            ...
            <section class="content">
                <div class="col-12 col-sm-6 col-lg-12">
                    <div class="card card-success card-tabs">
                        ...
                        <br />
                        Scan Surat Pernyataan Kesanggupan Mengawasi Mahasiswa Bimbingan Skripsi / Tugas Akhir <a href="http://saintek.uin-malang.ac.id/online/doc/Lampiran6.docx"><b>Download Form Lampiran 6</b></a>
                        <br />
                        <br />
                        <form action="ajaxupload.php" enctype="multipart/form-data" class="form-horizontal" method="post">
                            ...
                            <button class="btn btn-block btn-primary btn-upload" name="upload" value="kesanggupanmengawasi"><i class="fa fa-arrow-up"></i> Upload Surat Pernyataan</button>
                        </form>
                        <?php
                        ...
                        ?>
                        <br />
                        <a href="lab-isi-lamp5.php" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali </a>
                        <?php
                        if ($cekhasil > 0) {
                        ?>
                            <a href="lab-isi-lamp7.php" class="btn btn-success"><i class="fa fa-arrow-right"></i> Berikutnya </a>
                        <?php
                        } else {
                        ?>
                            <a href="lab-isi-lamp7.php" class="btn btn-success disabled"><i class="fa fa-arrow-right"></i> Berikutnya </a>
                        <?php
                        }
                        ?>
                    </div>
