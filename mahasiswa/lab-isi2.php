	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			if ($kapasitas > 0) {
				...
				echo "<script>alert('ERROR!! Mohon maaf kapasitas lab. sudah penuh. Silahkan pilih lab. lain yang masih tersedia');
					document.location='lab-isi1.php'</script>";
			}
			?>
				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						...
						<form role="form" method="POST" action="lab-simpan.php">
							...
							<input type="text" class="form-control" name="ttl" value="<?php if (isset($ttl)) {
																							echo $ttl;
																						}
																						?>" required>
							</input>
							...
							<textarea class="form-control" rows="3" id="alamatasal" name="alamatasal" required><?php if (isset($alamat_asal)) {
																													echo $alamat_asal;
																												}
																												?></textarea>
							<br />
							<label>Alamat Di Malang </label><small style="color:blue"><i> tuliskan <b>TIDAK ADA</b> apabila tidak tinggal di Malang </i></small><br />
							<textarea class="form-control" rows="3" id="alamatmalang" name="alamatmalang" required><?php if (isset($alamatmalang)) {
																														echo $alamatmalang;
																													}
																													?></textarea>
							<br />
							<label>No. HP </label><small style="color:blue"><i> wajib di isi </i></small><br />
							<input type="number" class="form-control" name="nohp" value="<?php if (isset($nohp)) {
																								echo $nohp;
																							}
																							?>" required>
							</input>
							...
							<input type="number" class="form-control" name="nohportu" value="<?php if (isset($nohportu)) {
																									echo $nohportu;
																								}
																								?>" required>
							</input>
							<br />
							<label>Riwayat Penyakit </label><small style="color:blue"><i> tuliskan <b>TIDAK ADA</b> apabila tidak pernah sakit </i></small><br />
							<textarea class="form-control" rows="3" id="riwayatpenyakit" name="riwayatpenyakit" required><?php if (isset($riwayatpenyakit)) {
																																echo $riwayatpenyakit;
																															} ?></textarea>
							<br />
							...
							<div class="search-box">
								<input type="text" autocomplete="off" placeholder="cari dosen" name="dosen" value="<?php if (isset($dosen)) {
																														echo $dosen;
																													} ?>" required>
								</input>
