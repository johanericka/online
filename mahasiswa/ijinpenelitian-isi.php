	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<?php
				...
				$query = "SELECT * FROM useraccount2 WHERE kode='$idmhs'";
				$datamhs = mysqli_query($dbsurat,$query);
				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						...
						<form role="form" method="post" action="ijinpenelitian-simpan.php">
							...
							<textarea class="form-control" rows="3" name="judulskripsi" placeholder="judul skripsi / penelitian" value="" required></textarea>
							<br/>
							Dosen Pembimbing <br/>
