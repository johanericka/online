	...
	<table table style="width:80%; margin-left:auto;margin-right:auto;" cellspacing="0" border="0">
		...
		<tbody>
			<tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td colspan="3">Maka kami mohon Bapak/Ibu berkenan memberikan izin pada mahasiswa tersebut untuk melakukan penelitian di <?php echo $instansi; ?> dengan waktu pelaksanaan pada tanggal <?php echo tgl_indo($tglpelaksanaan); ?> sampai dengan <?php echo tgl_indo($tglselesai); ?>.</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
