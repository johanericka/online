                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="box-body">
                                            <table class="table table-bordered" id="tabel">
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($data == 0) {
                                                        $qtambah = "INSERT into observasianggota (nimketua, nimanggota, nama) 
																		values('" . $nim . "','" . $nim . "','" . $nama . "')";
                                    ...
                                    <a href="observasi-simpan.php?nodata=<?= $nodata; ?>" class="btn btn-success btn-block" onclick="return confirm('Dengan ini saya menyatakan bahwa data yang saya isi adalah benar')"> <i class="fa fa-check"></i> Ajukan </a>
                                </div>
                            </div>
                        </div>
                    </div>
