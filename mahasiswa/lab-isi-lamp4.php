			...
			<section class="content">
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						...
						<br/>
						Scan Surat Pernyataan Melaksanakan Karantina Mandiri <a href="http://saintek.uin-malang.ac.id/online/doc/Lampiran4.docx"><b>Download Lampiran 4 </b></a>
						<br/>
						...
						<?php
							...
							if($ext == "pdf"){
						?>
							<div><iframe src="<?php echo $namafile; ?>" width="50%" height="500px" ></iframe></div>
						<?php
							}else{
						?>
						...
						?>
						<br/>
						<a href="lab-isi-lamp1.php" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali </a>
						<?php 
							if($cekhasil > 0){
						?>
							<a href="lab-isi-lamp5.php" class="btn btn-success"><i class="fa fa-arrow-right"></i> Berikutnya </a>
						<?php
							}else{
						?>
							<a href="lab-isi-lamp5.php" class="btn btn-success disabled"><i class="fa fa-arrow-right"></i> Berikutnya </a>
						<?php
							}
						?>
					</div>
