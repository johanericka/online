	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="content">
					<div class="container-fluid">
						<h1 style="text-align:center">Mohon Maaf <?php echo $nama; ?></h1>
						<h2 style="text-align:center">Untuk peningkatan pelayanan, menu ini sedang dalam perbaikan </h2>
						<h2 style="text-align:center">Silahkan coba kembali menu ini beberapa saat lagi</h2>
						<br/>
						<h4 style="text-align:center">Mohon maaf atas ketidak nyamanan ini</h4>
