									...
									?>
										<tr>
											...
											<td>
												...
												if ($validasidosen == 0) {
												?>
													menunggu verifikasi <i class="fa fa-spinner" aria-hidden="true"></i> <br />
												<?php
												} elseif ($validasidosen == 1) {
												?>
													telah menyetujui <i class="fa fa-check" aria-hidden="true"></i> <br />
												<?php
												} else {
												?>
													menolak dengan alasan <?= $keterangan; ?><br />
												<?php
												};
												?>
												Ketua Program Studi
												...
												?>
													menuggu verifikasi <i class="fa fa-spinner" aria-hidden="true"></i> <br />
												<?php
									...
									?>
												...
												<tr>
													...
													<td>
														...
														?>
															menolak dengan alasan <b><?= $keterangan; ?></b> <br />
														<?php
														};
														?>
														Ketua Program Studi
									...
									?>
										<tr>
											...
											<td>
												...
												Ketua Program Studi
												<?php
												if ($verifikasi1 < 2 and $verifikasi2 == 0) {
												?>
													menuggu verifikasi <i class="fa fa-spinner" aria-hidden="true"></i> <br />
												<?php
												} elseif ($verifikasi1 < 2 and $verifikasi2 == 1) {
												?>
													telah menyetujui <i class="fa fa-check" aria-hidden="true"></i> <br />
												<?php
												} else {
												...
												Wakil Dekan Akademik
												<?php
												if ($verifikasi1 < 2 and $verifikasi3 == 0) {
												?>
													menunggu verifikasi <i class="fa fa-spinner" aria-hidden="true"></i> <br />
												<?php
												} elseif ($verifikasi1 < 2 and $verifikasi3 == 1) {
												?>
													telah menyetujui <i class="fa fa-check" aria-hidden="true"></i> <br />
												<?php
												} else {
