...
//masukin data
$stmt = $dbsurat->prepare("INSERT INTO suket (tanggal, nim, nama, prodi, jenissurat, validator1, validator2, validator3,statussurat) VALUES (?,?,?,?,?,?,?,?,?)");
$stmt->bind_param("ssssssssi", $tanggal, $nim, $nama, $prodi, $jenissurat, $nipdosen, $nipkaprodi, $nipwd, $statussurat);
$stmt->execute();
...
*/
header('location:suket-ukt-isilampiran.php');
