		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h3>Pengajuan Surat Pengantar PKL</h3>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
			...
			<!-- Main content -->
			<?php
			$idmhs = mysqli_real_escape_string($dbsurat, $_SESSION['iduser']);
			$datamhs = mysqli_query($dbsurat, "select * from pkl where nim='$idmhs'");
			...
			$validasikoordinator = $row['validasikoordinator'];
			...
			<div class="content">
				<div class="container-fluid">
					...
					<br />
					<label>Dengan ini mendaftarkan diri sebagai perserta PKL di </label><br />
					<br />
					...
					<textarea class="form-control" rows="3" name="tempatpkl" readonly><?php echo $tempatpkl; ?></textarea>
					<label>Alamat </label>
					...
					<?php
					if ($validasikoordinator == 2 or $validasijurusan == 2 or $validasifakultas == 2) {
					?>
						<font color="red">Alasan Penolakan (*)</font>
						<textarea class="form-control" rows="3" name="keterangan" readonly><?php echo $keterangan; ?></textarea>
					<?php
					}
					?>
					...
					<?php
					$query = mysqli_query($dbsurat, "SELECT * FROM upload WHERE nim='$nim' AND nodata = '$nodata' AND keterangan='paktaintegritaspkl'");
