			...
			<section class="content">
				<div class="content">
					<div class="container-fluid">
						...
						<?php
						if (isset($_GET['pesan'])) {
							if (isset($pesan) and $pesan == "gagal") {
						?>
								<div class="alert alert-danger alert-dismissible fade show">
									<button type="button" class="close" data-dismiss="alert">&times;</button>
									<strong>ERROR :</strong> Data Dosen Wali tidak ditemukan!!
								</div>
						<?php
							}
						}
						...
						<form role="FORM" method="POST">
							...
							<div class="form-group">
								<div class="search-box">
									<input type="text" class="form-control" autocomplete="off" name="dosen" />
									<div class="result"></div>
								</div>
								<small style="color:blue"><i>ketikkan nama Dosen Wali anda dan pilih dari daftar nama yang tampil</i></small>
							</div>
							...
							<button type="submit" value="upload" formaction="skpi-isi.php" class="btn btn-secondary"> <i class="fa fa-arrow-left"></i> Ubah Data</button>
							<button type="submit" value="ajukan" formaction="skpi-simpanajukan.php" class="btn btn-warning"> <i class="fa fa-graduation-cap"></i> Ajukan</button>
						</form>
					</div><!-- /.container-fluid -->
				</div>
