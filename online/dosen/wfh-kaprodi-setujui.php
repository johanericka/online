...
$sql1 = mysqli_query($dbsurat, "SELECT * FROM wfh WHERE no='$nodata'");
...
$pesan = "Yth. " . $namawd2 . "<br/>
		...
		Dengan hormat,
		<br />
        Terdapat pengajuan surat Ijin <i>Work From Home</i> atas nama " . $namadosen . " di sistem SAINTEK Online.<br/>
