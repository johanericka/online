				...
				<div class="content">
					<div class="container-fluid">
						...
						<div class="alert alert-danger alert-dismissible fade show">
							...
							<strong>ERROR :</strong> Data Dosen Pembimbing Akademik tidak ditemukan!!
						</div>
						<?php
						}
						?>
						<form role="FORM" method="POST">
							<label>Dosen Pembimbing Akademik</label><br/>
							<div class="form-group">
								<div class="search-box">
									<input type="text" class="form-control" autocomplete="off" name="dosen"/>
									<div class="result"></div>
								</div>
								<small><i>ketikkan nama dosen pembimbing akademik anda</i></small>
							</div>
