<?php
  ...
  $nim = $_POST['nim'];
	...
	//dapatkan nama WD
	$query2 = mysqli_query($dbsurat,"SELECT * FROM pejabat WHERE iddosen = 'kdwd'");
	...
	//cari email WD
	$sql5 = mysqli_query($dbsurat,"SELECT * FROM notifikasi WHERE iduser = '$kdwd'");
		...
		$data4 = mysqli_fetch_array($sql4);
			...
			if($kirimemailuser > 0){
				...
				$pesan = "Yth. ".$namamhs."
									<br/>
									<br/>
									Pengajuan Surat Peminjaman Alat anda telah diverifikasi oleh Ketua Program Studi.
									<br/>
									Saat ini sedang menunggu verifikasi dari Wakil Dekan Bidang Akademik.
									<br/>
									<small><i>email notifikasi ini dapat di non-aktifkan dari menu Notifikasi pada sistem <a href='https://saintek.uin-malang.ac.id/online' target='_blank'>SAINTEK Online</a>.</i></small>";
