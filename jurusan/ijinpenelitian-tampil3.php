				...
				<div class="col-12 col-sm-6 col-lg-12">
					<div class="card card-success card-tabs">
						<form role="FORM" method="POST" >
							<label>Dalam rangka menyelesaikan skripsi / penelitian saya </label><br/>
							<label>Nama</label> <br/>
							...
							<small style="color:blue"><i>Telah disetujui dosen pembimbing pada tanggal <?php echo tgl_indo($tglvalidasidosen); ?></i></small>
							<br/>
							<br/>
