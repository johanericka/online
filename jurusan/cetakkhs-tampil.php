		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h3>Pengajuan Surat Permohonan Cetak KHS</h3>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
			...
			<?php
				...
				$row = mysqli_fetch_array($datamhs);
					...
					$alasan = $row['alasan'];
					$alasanbelumdiambil = $row['alasanbelumdiambil'];
			?>
					...
					<div class="card card-success card-tabs">
						<form>
							...
							<div class="form-group">
								...
								<div class="form-check">
									<input class="form-check-input" type="radio" name="semester" value="2" checked>
									<label class="form-check-label">Semester 2</label>
								</div>
							</div>
							<?php
							...
							Tahun Akademik 
							<div class="form-group">
								<input type="text" class="form-control" name="tahunakademik" value="<?php echo $tahunakademik; ?>" readonly/></input> 
							</div>
							<div class="form-group">
								<label>Keperluan</label>
								<textarea class="form-control" rows="2" placeholder="" name = "keperluan" readonly><?php echo $keperluan; ?></textarea>
							</div>
							Alasan <br/>
							<div class="form-group">
								<input type="text" class="form-control" name="alasan" value="<?php echo $alasan; ?>" readonly/></input> 
								Alasan Belum Diambil
								<br/>
								<textarea class="form-control" rows="3" name="alasanbelumdiambil" readonly><?php echo $alasanbelumdiambil; ?></textarea>
							</div>
							<?php
								$respon = $_GET['respon'];
								if ($respon == "kosong"){
							...
							<button name ="aksi" value="setujui" type="submit" formaction="cetakkhs-setujui.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
							<button name ="aksi" value="tolak" type="submit" formaction="cetakkhs-tolak.php" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
						</form>
					</div>
				</div>
