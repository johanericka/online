		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-6">
						<div class="col-sm-6">
							<h3>Validasi Data SKPI</h3>
							<h5>Sebagai Ketua Program Studi</h5>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
			...
			$qmhs = mysqli_query($dbsurat, "SELECT * FROM skpi_prestasipenghargaan WHERE nim='$nim' GROUP BY nim");
							...
							<div class="card-body p-0">
								<table class="table table-striped">
									...
									<tbody>
										...
										$qprestasi = mysqli_query($dbsurat, "SELECT * FROM skpi_prestasipenghargaan WHERE nim='$nim' AND aktivitas IS NOT NULL AND verifikator2='$iduser' AND verifikasi2=0 AND verifikasi1=1");
						...
						<form role="form" method="POST">
							<div class="card">
								...
								<div class="card-body">
									...
									<?php
									$qcpl = mysqli_query($dbsurat, "SELECT * FROM skpi WHERE jurusan='$jurusanmhs' AND cpl='Kemampuan Kerja' AND nim='$nim' ORDER BY indonesia");
									while ($cpl = mysqli_fetch_array($qcpl)) {
										$kemampuankerja = $cpl['cpl'];
										...
										<div class="row">
											<div class="form-group">
												<div class="form-check">
													<?php
													//cari data default
													$qdef = mysqli_query($dbsurat, "SELECT * FROM skpi_cpl WHERE indonesia='$indonesia'");
													$ndef = mysqli_num_rows($qdef);
													if ($ndef > 0) {
														$ddef = mysqli_fetch_array($qdef);
														$nodata = $ddef['no'];
														$def = $ddef['def'];
													}
													if ($def == 2) {
									...
									<?php
									$qcpl2 = mysqli_query($dbsurat, "SELECT * FROM skpi WHERE jurusan='$jurusanmhs' AND cpl='Penguasaan Pengetahuan' AND nim='$nim' ORDER BY indonesia");
									while ($cpl2 = mysqli_fetch_array($qcpl2)) {
										$kemampuankerja = $cpl2['cpl'];
									...
									<b>Sikap Khusus</b>
									<?php
									$qcpl3 = mysqli_query($dbsurat, "SELECT * FROM skpi WHERE jurusan='$jurusanmhs' AND cpl='Sikap Khusus' AND nim='$nim' ORDER BY indonesia");
									while ($cpl3 = mysqli_fetch_array($qcpl3)) {
										$kemampuankerja = $cpl3['cpl'];
