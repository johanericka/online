					...
					<div class="card card-success card-tabs">
						<form role="FORM" method="POST">
							<div class="container-fluid">
								...
								<button name="aksi" value="setujui" type="submit" formaction="observasi-setujui.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
								<button name="aksi" value="tolak" type="submit" formaction="observasi-tolak.php" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
							</div>
						</form>
					</div>
				</div>
