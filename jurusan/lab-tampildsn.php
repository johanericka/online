							...
							<div class="tab-content" id="custom-tabs-one-tabContent">
								<div class="tab-pane fade show active" id="custom-tabs-one-datadiri" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
									<form role="form" method="POST" action="lab-simpan.php">
										...
										Telah di setujui oleh dosen pembimbing pada tanggal <?php echo tgl_indo($tglvalidasidosen); ?> <br/>
										<br/>
										Waktu Penggunaan
										...
										<button name ="aksi" value="setujui" type="submit" formaction="lab-setujuidsn.php" class="btn btn-success"> <i class="fa fa-check"></i> Setujui</button>
										<button name ="aksi" value="tolak" type="submit" formaction="lab-tolakdsn.php?nodata=<?php echo $nodata; ?>" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
									</form>
								</div>
