...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			$qmhs = mysqli_query($dbsurat, "SELECT * FROM skpi_prestasipenghargaan WHERE nim='$nim' AND verifikator1='$iduser'");
				...
				<div class="content">
					<div class="container-fluid">
						...
						<form role="form" method="POST" action="skpi-setujui.php">
							...
							<br />
							<br />
							<input type="hidden" class="form-control" name="nosurat" value="<?= $nosurat; ?>" />
							...
							<button name="aksi" value="tolak" type="submit" formaction="skpi-tolak.php" class="btn btn-danger"> <i class="fa fa-times"></i> Tolak</button>
							<br />
						</form>
					</div>
				</div>
