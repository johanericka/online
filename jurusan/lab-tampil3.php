							...
							<div class="tab-content" id="custom-tabs-one-tabContent">
								<div class="tab-pane fade show active" id="custom-tabs-one-datadiri" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
									<form role="form" method="POST" action="lab-simpan.php">
										...
										<font style="color:blue">Telah di setujui oleh dosen pembimbing pada tanggal <?php echo tgl_indo($tglvalidasidosen); ?></font> <br />
										<font style="color:blue">Telah di setujui oleh Ketua Program Studi pada tanggal <?php echo tgl_indo($tglvalidasijurusan); ?> </font><br />
										<br />
										Waktu Penggunaan
										...
										<button name="aksi" value="cetak" type="submit" formaction="../mahasiswa/lab-cetak.php?nodata=<?php echo $nodata; ?>" class="btn btn-success"> <i class="fa fa-print"></i> Cetak</button>
									</form>
								</div>
