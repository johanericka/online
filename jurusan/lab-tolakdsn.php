<?php
		...
		$data4 = mysqli_fetch_array($sql4);
			...
			if($kirimemailmhs == 1){
				...
				$pesanmhs = "Yth. ".$nama."
									<br/>
									<br/>
									Pengajuan Ijin Penggunaan Laboratorium anda DITOLAK oleh Dosen Pembimbing dengan alasan ".$keterangan."
									<br/>
									<br/>
	...
	if (!empty($keterangan)){
		...
		header("location:lab-tampildsn.php?nodata=$nodata&respon=kosong");
	}
